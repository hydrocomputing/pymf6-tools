...
# hard wire path to change debug 
# os.chdir('C:/TUBAF/MODSIMPLE2/pymf6tools/tests/models/example_2')
# nam_file = r'C:/TUBAF/MODSIMPLE2/pymf6tools/tests/models/example_2/mfsim.nam'
